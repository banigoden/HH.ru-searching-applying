...
/*
Avoid hardcoding values such as file paths, URLs, or XPath selectors. Utilize configuration files or constants instead.
 */
...
public class HeadHunter {
    ...
    public HeadHunter(ConfigurationLoader configurationLoader) {
    ...
    public void connection() {
        ...
        FirefoxProfile profile = new FirefoxProfile(new File("C:\\Users\\xbandude1\\AppData\\Roaming\\Mozilla\\Firefox\\Profiles\\kl1plb6i.default-release")); //copy profile
    ...
    public void signIn() {
        String userLogin = configurationLoader.getProperty("headhunter.login.username");
        String password = configurationLoader.getProperty("headhunter.login.password");
